    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Mercaderia>().HasData(
                ...
                new Mercaderia { MercaderiaId = 3, Nombre = "Pizza con aceitunas", Precio = 350, Ingredientes = "Harina, queso, salsa y aceitunas negras", Preparacion = "Hornear pizza y agregar aceitunas", Imagen = "https://okdiario.com/img/2019/01/17/pizza-de-atun-con-aceitunas-negras-655x368.jpg", TipoMercaderiaId = 5 },
