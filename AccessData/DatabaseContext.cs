    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Mercaderia>().HasData(
                ...
                new Mercaderia { MercaderiaId = 3, Nombre = "Pizza de atún", Precio = 350, Ingredientes = "Harina, queso, atún y aceitunas negras", Preparacion = "Hornear pizza y agregar aceitunas", Imagen = "https://okdiario.com/img/2019/01/17/pizza-de-atun-con-aceitunas-negras-655x368.jpg", TipoMercaderiaId = 5 },
                ...
                new Mercaderia { MercaderiaId = 7, Nombre = "Ensalada Waldorf", Precio = 150, Ingredientes = "Lechuga, nueces, hinojo y hongos", Preparacion = "Cortar ingredientes y mezclar en una fuente", Imagen = "http://alicante.com.ar/uploads/recetas/94_receta.jpg", TipoMercaderiaId = 7 },
